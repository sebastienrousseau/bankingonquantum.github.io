...
description: "Peer-reviewed, Sigstore-signed technical research papers, architectural breakdowns, and supervisory analysis for financial practitioners."
...
<div class="article-grid my-4">
  <article class="article-card" id="cbom">
    ...
    <a href="/banks/secure/index.html" class="author-link">Read Technical Breakdown →</a>
  </article>
  ...
  <article class="article-card" id="scorecard">
    ...
    <a href="/boards/index.html" class="author-link">Read Board Framework →</a>
  </article>
  ...
  <article class="article-card" id="cib">
    ...
    <a href="/banks/index.html" class="author-link">Read CIB Architecture →</a>
  </article>
  ...
  <article class="article-card" id="dora">
    ...
    <a href="/banks/comply/index.html" class="author-link">Read DORA Analysis →</a>
  </article>

  <article class="article-card" id="finos">
    <div>
      <div class="article-date">
        <span>3 August 2026</span>
        <span class="sigstore-badge">✓ Sigstore Signed</span>
      </div>
    ...
    <a href="/toolkit/index.html" class="author-link">Read Open Source Essay →</a>
  </article>
  ...
  <article class="article-card" id="risk-horizon">
    ...
    <a href="/about/index.html" class="author-link">Read Strategic Perspective →</a>
  </article>
</div>
